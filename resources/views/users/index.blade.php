...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/icons/apple-touch-icon')}}')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/images/icons/favicon-32x32')}}')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/icons/favicon-16x16')}}')}}">
        ...
        <main class="main">
            <div class="intro-slider-container mb-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                    ...
                    <div class="intro-slide" style="background-image: url({{ asset('assets/images/demos/demo-4/slider/slide-1')}}')}});">
                    ...
                    <div class="intro-slide" style="background-image: url({{ asset('assets/images/demos/demo-4/slider/slide-2.png')}});">
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('assets/images/demos/demo-4/cats/4.png')}}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-4/products/product-1.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-4/products/product-2.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-4/products/product-3.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-4/products/product-4.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-top">Top</span>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-4/products/product-5.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                                    ...
                                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <span class="product-label label-circle label-top">Top</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/images/demos/demo-4/products/product-6.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/images/demos/demo-4/products/product-7.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <span class="product-label label-circle label-new">New</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/images/demos/demo-4/products/product-8.jpg')}}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                ...
                                                <span class="product-label label-circle label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/images/demos/demo-4/products/product-9.jpg')}}" alt="Product image" class="product-image">
                                                </a>
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="{{ asset('assets/images/demos/demo-4/logo-footer.png')}}" class="footer-logo" alt="Footer Logo" width="105" height="25">
